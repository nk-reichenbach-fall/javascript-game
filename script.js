window.addEventListener("load", function () {
  ...
  class Particle { 
    constructor(game, x, y){
      ...
      this.markedForDeletion = false;
      this.bounce = 0;
      this.bounceBoundaryLimit = Math.random() * 100;
    }
    update(){
      ...
      if(this.y > this.game.height - this.bounceBoundaryLimit && this.bounce < 2){
        this.bounce++;
        this.speedY *= -0.5;
      }
    }
  ...
  class Game {
    ...
    addEnemy() {
      ...
      if(this.randomize < 0.3){
        this.enemies.push(new Angler1(this))
      } else if (this.randomize < 0.6){
